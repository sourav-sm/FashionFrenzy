...
//         await fetch('https://backend3-j9x6.onrender.com/upload', {    
//                 method: 'POST',
//                 headers: {
...
//                 await fetch('https://backend3-j9x6.onrender.com/addproduct',{
//                     method:'POST',
//                     headers:{
//                         Accept:'application/json',
...
const AddProduct = () => {
    ...
    const Add_Product = async () => {
        ...
        try {
            ...
            const uploadResponse = await fetch('https://backend3-j9x6.onrender.com/upload', {
                method: 'POST',
                body: formData,
            });
            ...
            if (responseData.success) {
                ...
                const addProductResponse = await fetch('https://backend3-j9x6.onrender.com/addproduct', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
